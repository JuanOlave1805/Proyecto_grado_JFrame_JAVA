...
public class Ingreso extends javax.swing.JFrame {
    ...
    private void usuario_textKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_usuario_textKeyTyped
        ...
        usuario_text = (JTextField) evt.getSource();
        String textoActual = usuario_text.getText();
    ...
    private void metodo_boton_ingresar() {
        ...
        String contrasena = String.valueOf(password_text.getPassword());
        ...
        // Establecer la contraseña en el objeto Usuario
        usuarioObj.setContrasena(contrasena);

        // Establecer la identificación del usuario en el objeto Usuario
        usuarioObj.setIdentificacion_Pk(Integer.parseInt(usuario));

        // Crear una instancia del controlador de validación
        validacionUsuario validacion = new validacionUsuario();

        // Ejecutar la validación del usuario
