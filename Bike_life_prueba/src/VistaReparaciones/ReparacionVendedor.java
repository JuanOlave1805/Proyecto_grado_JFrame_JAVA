...
public class ReparacionVendedor extends javax.swing.JFrame {

    public ReparacionVendedor() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Reparaciones Admin");
        ...
        Boton_agregar2.setText("Finalizar Reparacion");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Logger.getLogger(ReparacionVendedor.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReparacionVendedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ReparacionVendedor().setVisible(true);
        });
    }
    ...
    public void metodoAgregar() {
        ...
        ReparacionAgregarVendedor ventana = new ReparacionAgregarVendedor();
        ventana.setVisible(true);
        // Rellenar el campo textIdUsuario con la identificación del usuario
        ventana.rellenarIdUsuario(idUsuario);
        this.setVisible(false);
    ...
    private void metodoBtnFinalizarReparacion() {
        String idUsuarioString = textIdUsuario.getText();
        int idUsuario = parseInt(idUsuarioString);
        // Abrir la ventana de Agregar reparacion
        ReparacionFinalizarVendedor ventana = new ReparacionFinalizarVendedor();
        ventana.setVisible(true);
        // Rellenar el campo textIdUsuario con la identificación del usuario
        ventana.rellenarIdUsuario(idUsuario);
        this.setVisible(false);
