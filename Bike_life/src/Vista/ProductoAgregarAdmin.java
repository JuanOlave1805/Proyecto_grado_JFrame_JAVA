 ...
 * @author Propietario
 */
public class ProductoAgregarAdmin extends javax.swing.JFrame {
    
    /**
     * Creates new form vistaAgregarUsuariosAdmin
     */
    public ProductoAgregarAdmin() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductoAgregarAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProductoAgregarAdmin().setVisible(true);
            }
        });
    }
    ...
    private void metodoBtnAgregar() {
        ...
        if (nombre.isEmpty() || precioCompraStr.isEmpty() || precioVentaStr.isEmpty() || cantidadStr.isEmpty() || 
        ...
        try {
            // Convertir los campos de texto a sus respectivos tipos numéricos
            precioCompra = Float.parseFloat(precioCompraStr);
            ...
            if (precioCompra <= 0 || precioVenta <= 0 || cantidad < 0) {
                // Mostrar un mensaje de advertencia si los valores no son válidos
                JOptionPane.showMessageDialog(this, "Por favor ingresa valores válidos para los precios y la cantidad.");
                return; // Salir del método si los valores no son válidos
            }
        } catch (NumberFormatException e) {
            // Mostrar un mensaje de advertencia si el formato numérico no es válido
            JOptionPane.showMessageDialog(this, "Por favor ingresa valores numéricos válidos.");
            return; // Salir del método si el formato numérico no es válido
        }
        ...
        objeto.setNombre(nombre.toUpperCase()); // Establecer el nombre del producto en mayúsculas
        objeto.setPrecio_compra(precioCompra); // Establecer el precio de compra
        objeto.setPrecio_venta(precioVenta); // Establecer el precio de venta
        objeto.setStock(cantidad); // Establecer la cantidad en stock
        categoriaobj.setnombre(categoria); // Establecer el nombre de la categoría
        proveedorobj.setNombre(proveedor); // Establecer el nombre del proveedor

        // Crear una instancia de metodoProducto para llamar al método agregar
        metodoProducto metodo = new metodoProducto();

        // Llamar al método agregar y guardar el resultado
        boolean resultado = metodo.agregar(objeto, categoriaobj, proveedorobj);

        // Verificar el resultado y mostrar el mensaje adecuado
        if (resultado) {
            // Mostrar un mensaje de éxito si el producto se agregó correctamente
            JOptionPane.showMessageDialog(null, "Producto agregado satisfactoriamente.");
            // Abrir la vista de administración de productos y ocultar la vista actual
            ProductosAdmin vista = new ProductosAdmin();
            vista.setVisible(true);
            this.setVisible(false);
        } else {
            // Mostrar un mensaje de error si ocurrió un problema al agregar el producto
