 ...
 * @author Propietario
 */
public class UsuariosActualizarAdmin extends javax.swing.JFrame {

    /**
     * Creates new form vistaEditarUsuariosAdmin
     */
    public UsuariosActualizarAdmin() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UsuariosActualizarAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UsuariosActualizarAdmin().setVisible(true);
            }
        });
    }
