 ...
 * @author JUAN DAVID
 */
public class ProveedorEliminarAdmin extends javax.swing.JFrame {

    /**
     * Creates new form vistaEliminarUsuarios
     */
    public ProveedorEliminarAdmin() {
        initComponents();
    ...
    private void tablaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaMouseClicked
        ...
        metodo.seleccionar(tabla, textIdentificacion, textNombreProveedor, textNombreEncargado, textTelefono, textCorreo);
    ...
    private void textTelefonoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textTelefonoKeyTyped
        ...
        if (textTelefono.getText().length() >= 2){
            evt.consume();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProveedorEliminarAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProveedorEliminarAdmin().setVisible(true);
            }
        });
    }
    ...
    private void cancelarEliminacion() {
        //Cambio a la vista de proveedores
    ...
    private void metodoConfirmarEliminacion() {
        ...
        // Asignar la identificación al objeto Proveedor
        objeto.setIdentificador_PK(identificacion);

        // Instanciar el controlador y ejecutar el método para eliminar el proveedor
        metodoProveedor metodo = new metodoProveedor();

        // Llamar al método eliminarUsuario pasando el objeto Proveedor
        if (metodo.eliminar(objeto)) {
            // Mostrar mensaje de éxito si el proveedor se eliminó correctamente
            JOptionPane.showMessageDialog(this, "Proveedor eliminado exitosamente.");

            // Cambio a la vista de administración de proveedores
            ProveedorAdmin proveedor = new ProveedorAdmin();
            proveedor.setVisible(true);
            this.setVisible(false);
        } else {
            // Mostrar mensaje de error si no se pudo eliminar el proveedor
