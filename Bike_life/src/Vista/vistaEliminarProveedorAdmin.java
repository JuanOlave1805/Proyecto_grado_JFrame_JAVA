 ...
 * @author JUAN DAVID
 */
public class vistaEliminarProveedorAdmin extends javax.swing.JFrame {

    /**
     * Creates new form vistaEliminarUsuarios
     */
    public vistaEliminarProveedorAdmin() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaEliminarProveedorAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vistaEliminarProveedorAdmin().setVisible(true);
            }
        });
    }
    ...
    objeto.setIdentificador_PK(identificacion); // Usar el método setter adecuado
