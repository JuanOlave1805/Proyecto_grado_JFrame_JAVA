 ...
 * @author JUAN DAVID
 */
public class UsuariosEliminarAdmin extends javax.swing.JFrame {

    /**
     * Creates new form vistaEliminarUsuarios
     */
    public UsuariosEliminarAdmin() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UsuariosEliminarAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UsuariosEliminarAdmin().setVisible(true);
            }
        });
    }
