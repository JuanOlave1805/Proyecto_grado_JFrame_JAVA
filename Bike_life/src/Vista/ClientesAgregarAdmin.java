 ...
 * @author Propietario
 */
public class ClientesAgregarAdmin extends javax.swing.JFrame {
    
    /**
     * Creates new form vistaAgregarUsuariosAdmin
     */
    public ClientesAgregarAdmin() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientesAgregarAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClientesAgregarAdmin().setVisible(true);
            }
        });
    }
    ...
    private void cargarTabla() {
        // Instancio el método de clientes
    ...
    private void metodoBtnAgregar() {
        ...
        metodoCliente metodo = new metodoCliente();
        metodo.agregarCliente(objeto, this);
    }
}
