 ...
 * @author Propietario
 */
public class vistaAgregarProductoAdmin extends javax.swing.JFrame {
    
    /**
     * Creates new form vistaAgregarUsuariosAdmin
     */
    public vistaAgregarProductoAdmin() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaAgregarProductoAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vistaAgregarProductoAdmin().setVisible(true);
            }
        });
    }
