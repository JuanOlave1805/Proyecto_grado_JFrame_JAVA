 ...
 * @author Propietario
 */
public class ProductoEliminarAdmin extends javax.swing.JFrame {
    
    /**
     * Creates new form vistaAgregarUsuariosAdmin
     */
    public ProductoEliminarAdmin() {
        initComponents();
        ...
        //Metodo cargar tabla de productos
        this.cargarTabla();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductoEliminarAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProductoEliminarAdmin().setVisible(true);
            }
        });
    }
    ...
    private void metodoBtnEliminar() {
        ...
        boolean resultado = metodo.eliminarProducto(objeto);
