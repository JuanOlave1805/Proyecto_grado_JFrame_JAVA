 ...
 * @author JUAN DAVID
 */
public class CategoriaProductosAdmin extends javax.swing.JFrame {

    /**
     * Creates new form vistaCategoriaProductosAdmin
     */
    public CategoriaProductosAdmin() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Categoria de productos");
        ...
        Boton_productos.setBackground(new java.awt.Color(0, 0, 0));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CategoriaProductosAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CategoriaProductosAdmin().setVisible(true);
            }
        });
    }
    ...
    private void metodo_boton_editar() {
        ...
        CategoriaProductoActualizarAdmin ventas = new CategoriaProductoActualizarAdmin();  
    ...
    private void metodoAgregar() {
        ...
        CategoriaProductoAgregarAdmin agregar = new CategoriaProductoAgregarAdmin();  
    ...
    private void metodoEliminar() {
        //Cambio a la vista de agregar usuarios
        CategoriaProductoEliminarAdmin eliminar = new CategoriaProductoEliminarAdmin();  
        eliminar.setVisible(true);
        this.setVisible(false);
    }

    private void metodo_productos() {
    ...
    private void metodo_boton_usuario() {
        UsuariosAdmin productos = new UsuariosAdmin();  
