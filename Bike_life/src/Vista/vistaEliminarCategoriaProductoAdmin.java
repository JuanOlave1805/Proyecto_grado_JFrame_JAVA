 ...
 * @author JUAN DAVID
 */
public class vistaEliminarCategoriaProductoAdmin extends javax.swing.JFrame {

    /**
     * Creates new form vistaEliminarCategoriaProductoAdmin
     */
    public vistaEliminarCategoriaProductoAdmin() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaEliminarCategoriaProductoAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vistaEliminarCategoriaProductoAdmin().setVisible(true);
            }
        });
    }
    ...
    if (validacion) {
        ...
        vistaCategoriaProductosAdmin vista = new vistaCategoriaProductosAdmin();  
