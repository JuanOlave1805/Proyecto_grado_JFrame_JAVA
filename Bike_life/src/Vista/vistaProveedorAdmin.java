 ...
 * @author JUAN DAVID
 */
public class vistaProveedorAdmin extends javax.swing.JFrame {

    /**
     * Creates new form vistaVentaAdmin
     */
    public vistaProveedorAdmin() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaProveedorAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new vistaProveedorAdmin().setVisible(true);
        });
    }
    ...
    private void metodoBotonEditar() {
        ...
        vistaEditarProveedorAdmin editar = new vistaEditarProveedorAdmin();  
    ...
    private void metodoAgregar() {
        ...
        vistaAgregarProveedorAdmin agregar = new vistaAgregarProveedorAdmin();  
    ...
    private void metodoEliminar() {
        //Cambio a la vista de agregar usuarios
        vistaEliminarProveedorAdmin eliminar = new vistaEliminarProveedorAdmin();  
