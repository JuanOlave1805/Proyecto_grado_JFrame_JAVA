 ...
 * @author Propietario
 */
public class vistaEditarProveedorAdmin extends javax.swing.JFrame {

    /**
     * Creates new form vistaEditarUsuariosAdmin
     */
    public vistaEditarProveedorAdmin() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(vistaEditarProveedorAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new vistaEditarProveedorAdmin().setVisible(true);
            }
        });
    }
    ...
    if (metodo.actualizarUsuario(objeto)) {
        ...
        vistaProveedorAdmin vista = new vistaProveedorAdmin();
