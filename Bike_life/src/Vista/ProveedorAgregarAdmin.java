 ...
 * @author Propietario
 */
public class ProveedorAgregarAdmin extends javax.swing.JFrame {
    
    /**
     * Creates new form vistaAgregarUsuariosAdmin
     */
    public ProveedorAgregarAdmin() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProveedorAgregarAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProveedorAgregarAdmin().setVisible(true);
            }
        });
    }
    ...
    private void metodoAgregar() {
        ...
        try {
            if(telefonoStr.length() != 10) {
                ...
                return; // Salir del método si la longitud del teléfono no es válida
            }
        } catch (NumberFormatException e) {
            // Mostrar mensaje de error si el formato del teléfono no es válido
        ...
        // Instanciar el controlador y ejecutar el método para agregar el proveedor
        metodoProveedor metodo = new metodoProveedor();
        metodo.agregarProveedor(objeto, this);
    }
