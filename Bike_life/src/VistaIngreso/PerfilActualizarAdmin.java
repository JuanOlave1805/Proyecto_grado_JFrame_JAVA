...
public class PerfilActualizarAdmin extends javax.swing.JFrame {
    ...
    private void metodoAgregar() throws SQLException {
        ...
        metodo.actualizarUsuario(idUsuario, textIdentificacion, textNombre, textApellido, textEdad, textCorreo, textTelefono, textContrasena);
        if(metodo.actualizarUsuario(idUsuario, textIdentificacion, textNombre, textApellido, textEdad, textCorreo, textTelefono, textContrasena)){
            PerfilAdmin ventana = new PerfilAdmin();
        ventana.setVisible(true);
        // Rellenar el campo textIdUsuario con la identificación del usuario
        ventana.rellenarIdUsuario(idUsuario);
    ...
    private void obtenerUsuario() throws SQLException{
        ...
        int idUsuario = parseInt(idUsuarioString);
        metodoUsuario metodo = new metodoUsuario();
        metodo.obtenerUsuarioPorId(idUsuario, textIdentificacion, textNombre, textApellido, textEdad, textCorreo, textTelefono, textContrasena);
    }
