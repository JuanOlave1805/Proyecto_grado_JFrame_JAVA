 ...
 * @author Propietario
 */
public class ClientesActualizarAdmin extends javax.swing.JFrame {

    /**
     * Creates new form vistaEditarUsuariosAdmin
     */
    public ClientesActualizarAdmin() {
        initComponents();
    ...
    private void tabla_usuariosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabla_usuariosMouseClicked
        ...
        metodo.seleccionUsuario(tabla_usuarios, textIdentificacion, textNombre, textApellido, textTelefono);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientesActualizarAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClientesActualizarAdmin().setVisible(true);
            }
        });
    }
    ...
    //Obtengo los datos de las cajas de texto del formulario
    ...
    //Instancio el objeto Usuario y le asigno los valores
    ...
    //Instanciacion y ejecutacion del metodo pasando como argumento el objeto
    metodoCliente metodo = new metodoCliente();
    metodo.actualizarCliente(objeto, this);

    if (metodo.actualizarCliente(objeto, this)) {
        JOptionPane.showMessageDialog(this, "Cliente actualizado exitosamente.");
        // Cambio a la vista de inicio
        ClientesAdmin ventas = new ClientesAdmin();
        ventas.setVisible(true);
        this.setVisible(false);
    } else {
