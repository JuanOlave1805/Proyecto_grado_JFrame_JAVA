...
public class CategoriaProductosAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Boton_editar.setText("Actualizar");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Logger.getLogger(CategoriaProductosAdmin.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void metodoEliminar() {
        ...
        int idUsuario = parseInt(idUsuarioString);
        // Abrir la ventana de Reparaciones
        CategoriaProductoEliminarAdmin ventana = new CategoriaProductoEliminarAdmin();
        ventana.setVisible(true);
        // Rellenar el campo textIdUsuario con la identificación del usuario
        ventana.rellenarIdUsuario(idUsuario);
    }
