    ...
    public void metodo_validacion(String usuario, String contrasena) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                // Si la conexión fue exitosa, realizar acciones necesarias aquí
                // Por ejemplo, cambiar a la vista de inicio (vistaVentaAdmin)
                vistaVentaAdmin inicio = new vistaVentaAdmin();
