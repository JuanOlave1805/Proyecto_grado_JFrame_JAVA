 ...
 * @author Propietario
 */
public class ReparacionFinalizarAdmin extends javax.swing.JFrame {

    /**
     * Creates new form vistaEditarUsuariosAdmin
     */
    public ReparacionFinalizarAdmin() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReparacionFinalizarAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReparacionFinalizarAdmin().setVisible(true);
            }
        });
    }
