...
public class ReparacionAdmin extends javax.swing.JFrame {

    public ReparacionAdmin() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            ...
            Logger.getLogger(ReparacionAdmin.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReparacionAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new ReparacionAdmin().setVisible(true);
        });
    }
    ...
    private void metodoBtnFinalizarReparacion() {
        ...
        int idUsuario = parseInt(idUsuarioString);
        // Abrir la ventana de Agregar reparacion
        ReparacionFinalizarAdmin ventana = new ReparacionFinalizarAdmin();
        ventana.setVisible(true);
        // Rellenar el campo textIdUsuario con la identificación del usuario
        ventana.rellenarIdUsuario(idUsuario);
        this.setVisible(false);
