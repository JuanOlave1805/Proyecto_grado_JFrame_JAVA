...
public class UsuariosAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Boton_producto.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        ...
        fondo.add(Boton_producto);
        Boton_producto.setBounds(30, 260, 130, 45);
    ...
    private void metodo_boton_editar() {
        ...
        int idUsuario = parseInt(idUsuarioString);
        // Abrir la ventana de Usuario
        UsuariosActualizarAdmin ventana = new UsuariosActualizarAdmin();
        ventana.setVisible(true);
        // Rellenar el campo textIdUsuario con la identificación del usuario
        ventana.rellenarIdUsuario(idUsuario);
        this.setVisible(false);
    ...
    private void metodoAgregar() {
        ...
        int idUsuario = parseInt(idUsuarioString);
        // Abrir la ventana de Usuario
        UsuariosAgregarAdmin ventana = new UsuariosAgregarAdmin();
        ventana.setVisible(true);
        // Rellenar el campo textIdUsuario con la identificación del usuario
        ventana.rellenarIdUsuario(idUsuario);
        this.setVisible(false);
